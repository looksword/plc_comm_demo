...
{	
	/// <summary>
	///  Defines constants related to the Fins protocol.
	/// </summary>
	internal static class Fins
	{			
		...
		// Fins slave exception offset that is added to the function code, to flag an exception
		public const byte ExceptionOffset = 128;

		// Fins slave exception codes
