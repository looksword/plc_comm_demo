...
namespace Fins.Data
{
	...
	/// </summary>
	public class DiscreteCollection : Collection<bool>, IFinsMessageDataCollection
	{
		/// <summary>
		...
		{
			return String.Concat("{", String.Join(", ", CollectionUtility.ToArray(SequenceUtility.ToList(this, delegate(bool discrete) { return discrete ? "1" : "0"; }))), "}");
		}
	}
}
