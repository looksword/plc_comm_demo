...
{
	/// <summary>
	/// Fins utility methods.
	/// </summary>
	public static class FinsUtility
	{
        ...
        /// Calculate FCS
        /// </summary>
        /// <param name="arrays">data</param>
        /// <returns>FCS value</returns>
        public static byte[] AsciiFCS(params byte[][] arrays)
        {
            int f = 0;
            ...
            return ASCIIEncoding.ASCII.GetBytes(f.ToString("X2"));
        }
        ...
        /// <returns>FCS value</returns>
        public static string AsciiFCS(string data, int dataLength)
        {
            int f = 0;
