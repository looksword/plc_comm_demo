...
namespace Gnm
{
	...
	public class SlaveException : Exception
	{
		...
		public override string Message
		{
			get
			{
				return String.Concat(base.Message, _slaveExceptionResponse != null ? String.Concat("\r\n", _slaveExceptionResponse) : String.Empty);
			}
		}
		...
		public byte SlaveExceptionCode
		{
			get
			{
				return _slaveExceptionResponse != null ? _slaveExceptionResponse.ExceptionCode.Value : (byte) 0;
			}
		}
		...
		public override void GetObjectData(SerializationInfo info, StreamingContext context)
		{
			...
			if (info != null && _slaveExceptionResponse != null)
			{
				...
				info.AddValue(SlaveExceptionCodePropertyName, _slaveExceptionResponse.ExceptionCode.Value);
			}
		}
#endif
	}
