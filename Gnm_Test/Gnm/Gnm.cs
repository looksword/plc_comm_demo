...
{	
	/// <summary>
	///  Defines constants related to the Gnm protocol.
	/// </summary>
	internal static class Gnm
	{			
        ...
        public const byte ReadXarea = 31;
        public const byte ReadYarea = 41;

		public const int MaximumDiscreteRequestResponseSize = 2040;
		public const int MaximumRegisterRequestResponseSize = 127; 

		// Gnm slave exception offset that is added to the function code, to flag an exception
		public const byte ExceptionOffset = 128;

		// Gnm slave exception codes
