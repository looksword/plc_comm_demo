...
namespace HslCommunication.Core.Net
{
    ...
    public abstract class NetworkBase
    {
        ...
        /// 是否使用同步的网络通讯
        /// </summary>
        public bool UseSynchronousNet { get; set; }
        ...
        {
            HslTimeOut timeout = obj as HslTimeOut;
            if (timeout != null)
            {
        ...
        {
            StateObjectAsync<byte[]> state = ar.AsyncState as StateObjectAsync<byte[]>;
            if (state != null)
            {
                try
                {
        ...
        {
            StateObjectAsync<bool> state = ar.AsyncState as StateObjectAsync<bool>;
            if (state != null)
            {
                try
                {
        ...
        {
            StateObjectAsync<Socket> state = ar.AsyncState as StateObjectAsync<Socket>;
            if (state != null)
            {
                try
                {
        ...
        {
            FileStateObject stateObject = ar.AsyncState as FileStateObject;
            if (stateObject != null)
            {
                try
                {
