        ...
        where TTransform : IByteTransform, new()
    {
        ...
        public virtual string IpAddress
        {
            ...
            set
            {
                ...
                {
                    IPAddress address;
                    if (!IPAddress.TryParse(value, out address))// IPAddress address ))
                    {
        ...
        {
            return string.Format("NetworkDoubleBase<{0}, {1}>", typeof(TNetMessage), typeof(TTransform));
        }
